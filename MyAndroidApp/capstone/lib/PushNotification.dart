...
class PushNotification {
  ...
  static void onNotificationTap(NotificationResponse notificationResponse) {
    debugPrint("Notification clicked with payload: ${notificationResponse.payload}");
  ...
  static Future showSimpleNotification({
    ...
    AndroidNotificationDetails('pomo_timer_alarm_1', 'pomo_timer_alarm',
        channelDescription: '타이머 완료 및 중요한 작업 알림을 위한 채널입니다.',
        importance: Importance.max,
  ...
  static Future<void> send({required String title, required String message}) async {
    ...
    final response = await client.post(
      Uri.parse(
          'https://fcm.googleapis.com/v1/projects/[1055034073890]/messages:send'),
      headers: {
